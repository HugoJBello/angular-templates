...
Filter.prototype.isNull = function(value){
    throw 'Not Implemented yet';
};

Filter.prototype.isBetween = function(lowerValue, upperValue){
    this['ogc:Filter'].comparisonOps = {
...
Filter.prototype.isEqualTo = function(value){
    this['ogc:Filter'].comparisonOps = {
...
Filter.prototype.isLessThanOrEqualTo = function(value){
    this['ogc:Filter'].comparisonOps = {
...
Filter.prototype.isGreaterThan = function(value){
    this['ogc:Filter'].comparisonOps = {
...
Filter.prototype.isLessThan = function(value){
    this['ogc:Filter'].comparisonOps = {
...
Filter.prototype.isGreaterThanOrEqualTo = function(value){
    this['ogc:Filter'].comparisonOps = {
...
Filter.prototype.isNotEqualTo = function(value){
    this['ogc:Filter'].comparisonOps = {
...
Filter.prototype.and = function(filter){
    if (typeof this['ogc:Filter'].logicOps === 'undefined') {
        ...
        if (typeof this['ogc:Filter'].comparisonOps !== 'undefined') {
            ...
            this['ogc:Filter'].logicOps['ogc:And'].ops = [this['ogc:Filter'].comparisonOps].concat(Filter.getPreviousOperator(filter));
            ...
            this['ogc:Filter'].logicOps['ogc:And'].ops = [this['ogc:Filter'].spatialOps].concat(Filter.getPreviousOperator(filter));
        ...
        this['ogc:Filter'].logicOps['ogc:And'].ops = this['ogc:Filter'].logicOps['ogc:And'].ops.concat(Filter.getPreviousOperator(filter));
    }
    return this;
};//*/
...
Filter.prototype.or = function(filter){
    if (typeof this['ogc:Filter'].logicOps === 'undefined') {
        ...
        if (typeof this['ogc:Filter'].comparisonOps !== 'undefined') {
            // Only has one previous filter and it is a comparison operator.
            this['ogc:Filter'].logicOps['ogc:Or'].ops = [this['ogc:Filter'].comparisonOps].concat(Filter.getPreviousOperator(filter));
            delete this['ogc:Filter'].comparisonOps;
        } else if (typeof this['ogc:Filter'].spatialOps !== 'undefined'){
            // Only has one previous filter and it is a spatial operator.
            this['ogc:Filter'].logicOps['ogc:Or'].ops = [this['ogc:Filter'].spatialOps].concat(Filter.getPreviousOperator(filter));
            delete this['ogc:Filter'].spatialOps;
        } else {
            throw 'Not Implemented yet, another operators';
        }
        ...
        this['ogc:Filter'].logicOps['ogc:Or'].ops = this['ogc:Filter'].logicOps['ogc:Or'].ops.concat(Filter.getPreviousOperator(filter));
    }
    return this;
};
...
Filter.JsonixContext = new Jsonix.Context(
    [
        OWS_1_0_0,
        DC_1_1,
        DCT,
...
Filter.prototype.getBasicFilterFromXML = function(xml){
    var unmarshaller = Filter.JsonixContext.createUnmarshaller();
